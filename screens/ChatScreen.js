...
export default class ChatScreen extends React.Component {
  ...
  async componentWillMount() {
    console.log("the current email is ", firebase.auth().currentUser.email);
    chat = [];
        ...
        <View style={styles.container}>
          <ListItem
            ...
            leftAvatar={{
              source: {
                uri:
                  "https://firebasestorage.googleapis.com/v0/b/manproject-8a2c9.appspot.com/o/avatars%2Fnazek%40gmail.com?alt=media&token=e959631a-e4a6-47a9-a2ce-fb373f6a159c",
                activeOpacity: 0.9
              }
            }}
            title={item.messages}
